/**
 * @(#)IdegaPasswordEncoder.java    1.0.0 14:47:04
 *
...
/**
 * <p>Custom encoder to check if password works for IDEGA ePlatform</p>
 * <p>You can report about problems to:
 * <a href="mailto:martynas@idega.is">Martynas Stakė</a></p>
 *
 * @version 1.0.0 2015 spal. 27
...
public class IdegaPasswordEncoder implements PasswordEncoder {
	...
	public String encode(CharSequence rawPassword) {
		...
		return Encrypter.encryptOneWay(rawPassword.toString());
	}
	...
	public boolean matches(CharSequence rawPassword, String encodedPassword) {
		String modifiedPassword = encode(rawPassword);

		String str = CoreConstants.EMPTY;
		char[] pass = modifiedPassword.toCharArray();
