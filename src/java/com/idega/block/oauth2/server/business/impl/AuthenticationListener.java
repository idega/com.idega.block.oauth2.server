...
public class AuthenticationListener extends DefaultSpringBean implements ApplicationListener<AbstractAuthenticationEvent> {

	public static final String BEAN_NAME = "authenticationListener";
	...
	public void onApplicationEvent(AbstractAuthenticationEvent event) {
		if (event instanceof AbstractAuthenticationFailureEvent) {
			getLogger().log(Level.WARNING, "Authentication to security context failed, cause of: ", 
